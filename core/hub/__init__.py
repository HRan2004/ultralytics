...
from core.hub.auth import Auth
from core.hub.session import HubTrainingSession
from core.hub.utils import PREFIX, split_key
from core.yolo.utils import LOGGER, emojis
from core.yolo.v8.detect import DetectionTrainer


def start(key=''):
    # Start training models with Ultralytics HUB. Usage: from src.core import start; start('API_KEY')
