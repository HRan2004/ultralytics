...
import core
from core.nn.modules import Detect, Segment
from core.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, guess_model_task
from core.yolo.cfg import get_cfg
from core.yolo.data.dataloaders.stream_loaders import LoadImages
from core.yolo.data.utils import check_det_dataset
from core.yolo.utils import DEFAULT_CFG, LOGGER, callbacks, colorstr, get_default_args, yaml_save
from core.yolo.utils.checks import check_imgsz, check_requirements, check_version, check_yaml
from core.yolo.utils.files import file_size
from core.yolo.utils.ops import Profile
from core.yolo.utils.torch_utils import select_device, smart_inference_mode
...
class Exporter:
    ...
    def _pipeline_coreml(self, model, prefix=colorstr('CoreML Pipeline:')):
        ...
        pipeline.spec.description.metadata.versionString = f'Ultralytics YOLOv{core.__version__}'
