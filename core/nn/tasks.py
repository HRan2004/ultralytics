...
from core.nn.modules import (C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x, Classify,
                             Concat, Conv, ConvTranspose, Detect, DWConv, DWConvTranspose2d, Ensemble, Focus,
                             GhostBottleneck, GhostConv, Segment)
from core.yolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, yaml_load
from core.yolo.utils.checks import check_requirements, check_yaml
from core.yolo.utils.torch_utils import (fuse_conv_and_bn, initialize_weights, intersect_dicts, make_divisible,
...
class ClassificationModel(BaseModel):
    ...
    def _from_detection_model(self, model, nc=1000, cutoff=10):
        ...
        from core.nn.autobackend import AutoBackend
...
def torch_safe_load(weight):
    ...
    """
    from core.yolo.utils.downloads import attempt_download
    ...
    try:
        ...
        if e.name == 'omegaconf':  # e.name is missing module name
            LOGGER.warning(f"WARNING ⚠️ {weight} requires {e.name}, which is not in core requirements."
