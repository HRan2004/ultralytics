...
from core.yolo.utils import LOGGER, ROOT, yaml_load
from core.yolo.utils.checks import check_requirements, check_suffix, check_version
from core.yolo.utils.downloads import attempt_download, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(self, weights='yolov8n.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if nn_module:
            ...
            from core.nn.tasks import attempt_load_weights
